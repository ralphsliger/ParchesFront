    ...
    <>
      <form className='flex border-4 p-2 contenido'>
        <div className=' w-11/12'>
          <textarea id='textMensajeComentario' value={data} onChange={(e) => setData(e.target.value)} maxLength='256' className='w-11/12 p-2 resize-none' required name='comentario' type='text' placeholder='Escribe tu comentario...' />
        </div>
        <div>
